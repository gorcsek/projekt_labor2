...
$allowed_ips = array(
	'140.82.115.','35.231.145.151','207.97.227.', '50.57.128.', '108.171.174.', '50.57.231.', '204.232.175.', '192.30.252.', // GitHub
...
$log .= "\n";
file_put_contents ('/tmp/deploy-log.txt',$log,FILE_APPEND);
echo $output; 
?>
</pre>
</body>
